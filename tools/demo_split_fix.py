...
parser.add_argument('--txt_root', default='Y:/children_hospital_dataset/other_labels', help='datasets')
parser.add_argument('--cls_id', default=4, help='class id')
args = parser.parse_args()
global_flag = True
if args.cls_id >= 2:
    if not os.path.basename(args.txt_root) == 'other_labels':
        args.txt_root = os.path.dirname(args.txt_root) + '/other_labels'
    assert os.path.basename(args.txt_root) == 'other_labels'
